              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-zinc-900 font-semibold hover:text-indigo-600 transition-colors"
                  >
              ...
              <div>
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex flex-col">
                    <span className="text-xs font-bold text-zinc-400 uppercase tracking-widest realtive">
                      Mobile
                    </span>
                    <a
                      href="mailto:hello@alexrivera.dev"
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <div className="flex space-x-4 mt-1">
                    <a
                      href="https://github.com/Shahriar-30"
                      target="#"
                      className="text-zinc-900 font-semibold hover:text-indigo-600 transition-colors"
                    >
                      GitHub
                    ...
                    <a
                      href="https://www.linkedin.com/in/shahriar-amin-al-siphat-7909412b0/"
                      target="#"
                      className="text-zinc-900 font-semibold hover:text-indigo-600 transition-colors"
                    >
                      LinkedIn
                    ...
                    <a
                      href="https://www.facebook.com/shahriaramin.alsiphat"
                      target="#"
                      className="text-zinc-900 font-semibold hover:text-indigo-600 transition-colors"
                    >
                      Facebook
            ...
            {submitted ? (
              <div className="h-full flex flex-col items-center justify-center text-center space-y-4">
                ...
                <p className="text-zinc-600">
                  Thanks for reaching out! I typically respond within 1 business
                  day.
                </p>
              </div>
            ) : (
